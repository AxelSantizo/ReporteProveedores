document.addEventListener('DOMContentLoaded', function() { 
        ...
        fetch(url, {
            ...
            .then(result => {
                ...
                if (!result.selectores) {
                    console.error('No se encontrÃ³ la propiedad "selectores" en la respuesta:', result);
                    return;
                }
    ...
    // Evento para el botÃ³n quitarFiltro
    document.getElementById('quitarfiltro').addEventListener('click', function () {
        showSpinner();
        // Restablecer los selectores a la opciÃ³n predeterminada y deja los campos vacÃ­os
    ...
    document.getElementById('exportFilter').addEventListener('click', function () {
        ...
        const fields = { sucursal, departamento, categoria, subcategoria, searchTerm};
